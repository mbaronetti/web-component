...
set className(a){return this.__shady_className=a}});function Ca(a){for(var b in a){var c=a[b];c&&(c.enumerable=!1)}}Ca(za);Ca(Aa);Ca(Ba);var Da=u.c||!0===u.g,Ea=Da?function(){}:function(a){var b=r(a);b.N||(b.N=!0,va(a,Ba))},Fa=Da?function(){}:function(a){var b=r(a);b.M||(b.M=!0,va(a,za),window.customElements&&window.customElements.polyfillWrapFlushCallback&&!u.g||va(a,Aa))};var E="__eventWrappers"+Date.now(),Ga=function(){var a=Object.getOwnPropertyDescriptor(Event.prototype,"composed");return a?function(b){return a.get.call(b)}:null}(),Ha=function(){function a(){}var b=!1,c={get capture(){b=!0;return!1}};window.addEventListener("test",a,c);window.removeEventListener("test",a,c);return b}();function Ia(a){if(a&&"object"===typeof a){var b=!!a.capture;var c=!!a.once;var d=!!a.passive;var e=a.i}else b=!!a,d=c=!1;return{K:e,capture:b,once:c,passive:d,J:Ha?a:b}}
...
Event.BUBBLING_PHASE,Ra(a,g,"bubble"),a.B)return}e=0;g=null}function Ta(a,b,c,d,e,f){for(var g=0;g<a.length;g++){var h=a[g],m=h.type,l=h.capture,k=h.once,q=h.passive;if(b===h.node&&c===m&&d===l&&e===k&&f===q)return g}return-1}function Ua(a){D();return!u.o&&this instanceof Node&&!qa(document,this)?(a.__target||Va(a,this),Sa(a)):this.__shady_native_dispatchEvent(a)}
function Wa(a,b,c){var d=Ia(c),e=d.capture,f=d.once,g=d.passive,h=d.K;d=d.J;if(b){var m=typeof b;if("function"===m||"object"===m)if("object"!==m||b.handleEvent&&"function"===typeof b.handleEvent){if(Ka[a])return this.__shady_native_addEventListener(a,b,d);var l=h||this;if(h=b[E]){if(-1<Ta(h,l,a,e,f,g))return}else b[E]=[];h=function(k){f&&this.__shady_removeEventListener(a,b,c);k.__target||Va(k);if(l!==this){var q=Object.getOwnPropertyDescriptor(k,"currentTarget");Object.defineProperty(k,"currentTarget",
{get:function(){return l},configurable:!0});var B=Object.getOwnPropertyDescriptor(k,"eventPhase");Object.defineProperty(k,"eventPhase",{configurable:!0,enumerable:!0,get:function(){return e?Event.CAPTURING_PHASE:Event.BUBBLING_PHASE}})}k.__previousCurrentTarget=k.currentTarget;if(!w(l)&&"slot"!==l.localName||-1!=k.composedPath().indexOf(l))if(k.composed||-1<k.composedPath().indexOf(l))if(Qa(k)&&k.target===k.relatedTarget)k.eventPhase===Event.BUBBLING_PHASE&&k.stopImmediatePropagation();else if(k.eventPhase===
Event.CAPTURING_PHASE||k.bubbles||k.target===l||l instanceof Window){var P="function"===m?b.call(l,k):b.handleEvent&&b.handleEvent(k);l!==this&&(q?(Object.defineProperty(k,"currentTarget",q),q=null):delete k.currentTarget,B?(Object.defineProperty(k,"eventPhase",B),B=null):delete k.eventPhase);return P}};b[E].push({node:l,type:a,capture:e,once:f,passive:g,V:h});this.__handlers=this.__handlers||{};this.__handlers[a]=this.__handlers[a]||{capture:[],bubble:[]};this.__handlers[a][e?"capture":"bubble"].push(h);
Pa[a]||this.__shady_native_addEventListener(a,h,d)}}}
function Xa(a,b,c){if(b){var d=Ia(c);c=d.capture;var e=d.once,f=d.passive,g=d.K;d=d.J;if(Ka[a])return this.__shady_native_removeEventListener(a,b,d);var h=g||this;g=void 0;var m=null;try{m=b[E]}catch(l){}m&&(e=Ta(m,h,a,c,e,f),-1<e&&(g=m.splice(e,1)[0].V,m.length||(b[E]=void 0)));this.__shady_native_removeEventListener(a,g||b,d);g&&this.__handlers&&this.__handlers[a]&&(a=this.__handlers[a][c?"capture":"bubble"],b=a.indexOf(g),-1<b&&a.splice(b,1))}}
...
var db=Object.getOwnPropertyNames(Element.prototype).filter(function(a){return"on"===a.substring(0,2)}),eb=Object.getOwnPropertyNames(HTMLElement.prototype).filter(function(a){return"on"===a.substring(0,2)});function fb(a){return{set:function(b){var c=r(this),d=a.substring(2);c.h||(c.h={});c.h[a]&&this.removeEventListener(d,c.h[a]);this.__shady_addEventListener(d,b);c.h[a]=b},get:function(){var b=t(this);return b&&b.h&&b.h[a]},configurable:!0}};var gb=A({dispatchEvent:Ua,addEventListener:Wa,removeEventListener:Xa});var hb=window.document,ib=u.o,jb=Object.getOwnPropertyDescriptor(Node.prototype,"isConnected"),kb=jb&&jb.get;function lb(a){for(var b;b=a.__shady_firstChild;)a.__shady_removeChild(b)}function mb(a){var b=t(a);if(b&&void 0!==b.A)for(b=a.__shady_firstChild;b;b=b.__shady_nextSibling)mb(b);if(a=t(a))a.A=void 0}function nb(a){var b=a;if(a&&"slot"===a.localName){var c=t(a);(c=c&&c.l)&&(b=c.length?c[0]:nb(a.__shady_nextSibling))}return b}
function ob(a,b,c){if(a=(a=t(a))&&a.m){if(b)if(b.nodeType===Node.DOCUMENT_FRAGMENT_NODE)for(var d=0,e=b.childNodes.length;d<e;d++)a.addedNodes.push(b.childNodes[d]);else a.addedNodes.push(b);c&&a.removedNodes.push(c);pb(a)}}
...
if(b){var c=t(b);c=c&&c.parentNode;if(void 0!==c&&c!==this||void 0===c&&b.__shady_native_parentNode!==this)throw Error("Failed to execute 'insertBefore' on 'Node': The node before which the new node is to be inserted is not a child of this node.");}if(b===a)return a;ob(this,a);var d=[],e=(c=G(this))?c.host.localName:H(this),f=a.__shady_parentNode;if(f){var g=H(a);var h=!!c||!G(a)||ib&&void 0!==this.__noInsertionPoint;f.__shady_removeChild(a,h)}f=!0;var m=(!ib||void 0===a.__noInsertionPoint&&void 0===
this.__noInsertionPoint)&&!qb(a,e),l=c&&!a.__noInsertionPoint&&(!ib||a.nodeType===Node.DOCUMENT_FRAGMENT_NODE);if(l||m)m&&(g=g||H(a)),rb(a,function(k){l&&"slot"===k.localName&&d.push(k);if(m){var q=g;I()&&(q&&sb(k,q),(q=I())&&q.scopeNode(k,e))}});d.length&&(tb(c),c.f.push.apply(c.f,d instanceof Array?d:ca(ba(d))),J(c));v(this)&&(ub(a,this,b),h=t(this),h.root?(f=!1,ja(this)&&J(h.root)):c&&"slot"===this.localName&&(f=!1,J(c)));f?(c=w(this)?this.host:this,b?(b=nb(b),c.__shady_native_insertBefore(a,b)):
c.__shady_native_appendChild(a)):a.ownerDocument!==this.ownerDocument&&this.ownerDocument.adoptNode(a);return a},appendChild:function(a){if(this!=a||!w(a))return this.__shady_insertBefore(a)},removeChild:function(a,b){b=void 0===b?!1:b;if(this.ownerDocument!==hb)return this.__shady_native_removeChild(a);if(a.__shady_parentNode!==this)throw Error("The node to be removed is not a child of this node: "+a);ob(this,null,a);var c=G(a),d=c&&vb(c,a),e=t(this);if(v(this)&&(wb(a,this),ja(this))){J(e.root);
var f=!0}if(I()&&!b&&c&&a.nodeType!==Node.TEXT_NODE){var g=H(a);rb(a,function(h){sb(h,g)})}mb(a);c&&((b="slot"===this.localName)&&(f=!0),(d||b)&&J(c));f||(f=w(this)?this.host:this,(!e.root&&"slot"!==a.localName||f===a.__shady_native_parentNode)&&f.__shady_native_removeChild(a));return a},replaceChild:function(a,b){this.__shady_insertBefore(a,b);this.__shady_removeChild(b);return a},cloneNode:function(a){if("template"==this.localName)return this.__shady_native_cloneNode(a);var b=this.__shady_native_cloneNode(!1);
if(a&&b.nodeType!==Node.ATTRIBUTE_NODE){a=this.__shady_firstChild;for(var c;a;a=a.__shady_nextSibling)c=a.__shady_cloneNode(!0),b.__shady_appendChild(c)}return b},getRootNode:function(a){if(this&&this.nodeType){var b=r(this),c=b.A;void 0===c&&(w(this)?(c=this,b.A=c):(c=(c=this.__shady_parentNode)?c.__shady_getRootNode(a):this,document.documentElement.__shady_native_contains(this)&&(b.A=c)));return c}},contains:function(a){return ra(this,a)}});var M=A({get assignedSlot(){var a=this.__shady_parentNode;(a=a&&a.__shady_shadowRoot)&&L(a);return(a=t(this))&&a.assignedSlot||null}});function xb(a,b,c){var d=[];yb(a,b,c,d);return d}function yb(a,b,c,d){for(a=a.__shady_firstChild;a;a=a.__shady_nextSibling){var e;if(e=a.nodeType===Node.ELEMENT_NODE){e=a;var f=b,g=c,h=d,m=f(e);m&&h.push(e);g&&g(m)?e=m:(yb(e,f,g,h),e=void 0)}if(e)break}}
...
Node.ELEMENT_NODE})):this.__shady_native_children},get childElementCount(){var a=this.__shady_children;return a?a.length:0}}),zb=A({querySelector:function(a){return xb(this,function(b){return la.call(b,a)},function(b){return!!b})[0]||null},querySelectorAll:function(a,b){if(b){b=Array.prototype.slice.call(this.__shady_native_querySelectorAll(a));var c=this.__shady_getRootNode();return y(b.filter(function(d){return d.__shady_getRootNode()==c}))}return y(xb(this,function(d){return la.call(d,a)}))}}),
Ab=u.o&&!u.g?wa({},N):N;wa(N,zb);var Bb=null;function I(){Bb||(Bb=window.ShadyCSS&&window.ShadyCSS.ScopingShim);return Bb||null}function Cb(a,b,c){var d=I();return d&&"class"===b?(d.setElementClass(a,c),!0):!1}function sb(a,b){var c=I();c&&c.unscopeNode(a,b)}function qb(a,b){var c=I();if(!c)return!0;if(a.nodeType===Node.DOCUMENT_FRAGMENT_NODE){c=!0;for(a=a.__shady_firstChild;a;a=a.__shady_nextSibling)c=c&&qb(a,b);return c}return a.nodeType!==Node.ELEMENT_NODE?!0:c.currentScopeForNode(a)===b}
function H(a){if(a.nodeType!==Node.ELEMENT_NODE)return"";var b=I();return b?b.currentScopeForNode(a):""}function rb(a,b){if(a)for(a.nodeType===Node.ELEMENT_NODE&&b(a),a=a.__shady_firstChild;a;a=a.__shady_nextSibling)a.nodeType===Node.ELEMENT_NODE&&rb(a,b)};var Db=window.document;function Eb(a,b){if("slot"===b)a=a.__shady_parentNode,ja(a)&&J(t(a).root);else if("slot"===a.localName&&"name"===b&&(b=G(a))){if(b.a){O(b);var c=a.O,d=Fb(a);if(d!==c){c=b.b[c];var e=c.indexOf(a);0<=e&&c.splice(e,1);c=b.b[d]||(b.b[d]=[]);c.push(a);1<c.length&&(b.b[d]=Gb(c))}}J(b)}}
var Q=A({get previousElementSibling(){var a=t(this);if(a&&void 0!==a.previousSibling){for(a=this.__shady_previousSibling;a&&a.nodeType!==Node.ELEMENT_NODE;)a=a.__shady_previousSibling;return a}return this.__shady_native_previousElementSibling},get nextElementSibling(){var a=t(this);if(a&&void 0!==a.nextSibling){for(a=this.__shady_nextSibling;a&&a.nodeType!==Node.ELEMENT_NODE;)a=a.__shady_nextSibling;return a}return this.__shady_native_nextElementSibling},get slot(){return this.getAttribute("slot")},
set slot(a){this.__shady_setAttribute("slot",a)},get className(){return this.getAttribute("class")||""},set className(a){this.__shady_setAttribute("class",a)},setAttribute:function(a,b){this.ownerDocument!==Db?this.__shady_native_setAttribute(a,b):Cb(this,a,b)||(this.__shady_native_setAttribute(a,b),Eb(this,a))},removeAttribute:function(a){this.ownerDocument!==Db?this.__shady_native_removeAttribute(a):Cb(this,a,"")?""===this.getAttribute(a)&&this.__shady_native_removeAttribute(a):(this.__shady_native_removeAttribute(a),
Eb(this,a))}});u.o||db.forEach(function(a){Q[a]=fb(a)});
var Lb=A({attachShadow:function(a){if(!this)throw Error("Must provide a host.");if(!a)throw Error("Not enough arguments.");if(a.shadyUpgradeFragment&&!u.L){var b=a.shadyUpgradeFragment;b.__proto__=ShadowRoot.prototype;Hb(b,this,a);Ib(b,b);a=b.__noInsertionPoint?null:b.querySelectorAll("slot");b.__noInsertionPoint=void 0;if(a&&a.length){var c=b;tb(c);c.f.push.apply(c.f,a instanceof Array?a:ca(ba(a)));J(b)}b.host.__shady_native_appendChild(b)}else b=new Jb(Kb,this,a);return this.__CE_shadowRoot=b},
get shadowRoot(){var a=t(this);return a&&a.U||null}});wa(Q,Lb);var Mb=/[&\u00A0"]/g,Nb=/[&\u00A0<>]/g;function Ob(a){switch(a){case "&":return"&amp;";case "<":return"&lt;";case ">":return"&gt;";case '"':return"&quot;";case "\u00a0":return"&nbsp;"}}function Pb(a){for(var b={},c=0;c<a.length;c++)b[a[c]]=!0;return b}var Qb=Pb("area base br col command embed hr img input keygen link meta param source track wbr".split(" ")),Rb=Pb("style script xmp iframe noembed noframes plaintext noscript".split(" "));
function Sb(a,b){"template"===a.localName&&(a=a.content);for(var c="",d=b?b(a):a.childNodes,e=0,f=d.length,g=void 0;e<f&&(g=d[e]);e++){a:{var h=g;var m=a,l=b;switch(h.nodeType){case Node.ELEMENT_NODE:m=h.localName;for(var k="<"+m,q=h.attributes,B=0,P;P=q[B];B++)k+=" "+P.name+'="'+P.value.replace(Mb,Ob)+'"';k+=">";h=Qb[m]?k:k+Sb(h,l)+"</"+m+">";break a;case Node.TEXT_NODE:h=h.data;h=m&&Rb[m.localName]?h:h.replace(Nb,Ob);break a;case Node.COMMENT_NODE:h="\x3c!--"+h.data+"--\x3e";break a;default:throw window.console.error(h),
...
function L(a){var b;if(b=a.j){for(var c;a;)a:{a.j&&(c=a),b=a;a=b.host.__shady_getRootNode();if(w(a)&&(b=t(b.host))&&0<b.u)break a;a=void 0}b=c}(c=b)&&c._renderSelf()}
...
else d.push(f);f=sa(e);g=ea(d,d.length,f,f.length);for(var m=h=0,l=void 0;h<g.length&&(l=g[h]);h++){for(var k=0,q=void 0;k<l.s.length&&(q=l.s[k]);k++)q.__shady_native_parentNode===e&&e.__shady_native_removeChild(q),f.splice(l.index+m,1);m-=l.v}m=0;for(l=void 0;m<g.length&&(l=g[m]);m++)for(h=f[l.index],k=l.index;k<l.index+l.v;k++)q=d[k],e.__shady_native_insertBefore(q,h),f.splice(k,0,q)}}if(!u.preferPerformance&&!this.H)for(b=this.host.__shady_firstChild;b;b=b.__shady_nextSibling)c=t(b),b.__shady_native_parentNode!==
...
function oc(a,b){b.__shady_native_dispatchEvent(new Event("slotchange"));b=t(b);b.assignedSlot&&oc(a,b.assignedSlot)}function tb(a){a.f=a.f||[];a.a=a.a||[];a.b=a.b||{}}function O(a){if(a.f&&a.f.length){for(var b=a.f,c,d=0;d<b.length;d++){var e=b[d];Ib(e);var f=e.__shady_parentNode;Ib(f);f=t(f);f.u=(f.u||0)+1;f=Fb(e);a.b[f]?(c=c||{},c[f]=!0,a.b[f].push(e)):a.b[f]=[e];a.a.push(e)}if(c)for(var g in c)a.b[g]=Gb(a.b[g]);a.f=[]}}
function Fb(a){var b=a.name||a.getAttribute("name")||"__catchall";return a.O=b}function Gb(a){return a.sort(function(b,c){b=lc(b);for(var d=lc(c),e=0;e<b.length;e++){c=b[e];var f=d[e];if(c!==f)return b=ta(c.__shady_parentNode),b.indexOf(c)-b.indexOf(f)}})}
function vb(a,b){if(a.a){O(a);var c=a.b,d;for(d in c)for(var e=c[d],f=0;f<e.length;f++){var g=e[f];if(ra(b,g)){e.splice(f,1);var h=a.a.indexOf(g);0<=h&&(a.a.splice(h,1),(h=t(g.__shady_parentNode))&&h.u&&h.u--);f--;g=t(g);if(h=g.l)for(var m=0;m<h.length;m++){var l=h[m],k=l.__shady_native_parentNode;k&&k.__shady_native_removeChild(l)}g.l=[];g.assignedNodes=[];h=!0}}return h}}function ka(a){O(a);return!(!a.a||!a.a.length)}
...
sc;Object.defineProperty(window.CustomElementRegistry.prototype,"define",{value:sc,configurable:!0})}function G(a){a=a.__shady_getRootNode();if(w(a))return a};function tc(){this.a=!1;this.addedNodes=[];this.removedNodes=[];this.w=new Set}function pb(a){a.a||(a.a=!0,pa(function(){a.flush()}))}tc.prototype.flush=function(){if(this.a){this.a=!1;var a=this.takeRecords();a.length&&this.w.forEach(function(b){b(a)})}};tc.prototype.takeRecords=function(){if(this.addedNodes.length||this.removedNodes.length){var a=[{addedNodes:this.addedNodes,removedNodes:this.removedNodes}];this.addedNodes=[];this.removedNodes=[];return a}return[]};
function uc(a,b){var c=r(a);c.m||(c.m=new tc);c.m.w.add(b);var d=c.m;return{P:b,S:d,R:a,takeRecords:function(){return d.takeRecords()}}}function vc(a){var b=a&&a.S;b&&(b.w.delete(a.P),b.w.size||(r(a.R).m=null))}
...
a}}});function Gc(a){Object.defineProperty(Z.prototype,a,{get:function(){return this.node["__shady_"+a]},set:function(b){this.node["__shady_"+a]=b},configurable:!0})}db.forEach(function(a){return Gc(a)});eb.forEach(function(a){return Gc(a)});var Hc=new WeakMap;function Ic(a){if(w(a)||a instanceof Z)return a;var b=Hc.get(a);b||(b=new Z(a),Hc.set(a,b));return b};if(u.F){var Jc=u.c?function(a){return a}:function(a){Fa(a);Ea(a);return a};window.ShadyDOM={inUse:u.F,patch:Jc,isShadyRoot:w,enqueue:ya,flush:D,flushInitial:function(a){!a.H&&a.j&&L(a)},settings:u,filterMutations:wc,observeChildren:uc,unobserveChildren:vc,deferConnectionCallbacks:u.deferConnectionCallbacks,preferPerformance:u.preferPerformance,handlesDynamicScoping:!0,wrap:u.g?Ic:Jc,wrapIfNeeded:!0===u.g?Ic:function(a){return a},Wrapper:Z,composedPath:Ma,noPatch:u.g,patchOnDemand:u.G,nativeMethods:yc,
nativeTree:zc,patchElementProto:dc};Fc();cc("__shady_");Object.defineProperty(document,"_activeElement",Yb.activeElement);z(Window.prototype,ac,"__shady_");u.g?u.G&&z(Element.prototype,Lb):(cc(),cb());Ya();window.Event=$a;window.CustomEvent=ab;window.MouseEvent=bb;window.ShadowRoot=Jb};}).call(this);
