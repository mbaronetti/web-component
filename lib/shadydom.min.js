  ...
  */
  ...
  function ea(a, b, c, d) {
    ...
    if (b == a.length && d == c.length) {
      ...
      for (var l = c.length, k = 0; k < m - g && fa(a[--h], c[--l]);) {
        k++;
      }
    ...
    for (l = 1; l < d; l++) {
      for (k = 1; k < h; k++) {
        if (a[m + k - 1] === c[g + l - 1]) b[l][k] = b[l - 1][k - 1];else {
          var q = b[l - 1][k] + 1,
              B = b[l][k - 1] + 1;
          b[l][k] = q < B ? q : B;
        }
    ...
    for (a = []; 0 < m || 0 < g;) {
      0 == m ? (a.push(2), g--) : 0 == g ? (a.push(3), m--) : (h = b[m - 1][g - 1], l = b[m - 1][g], k = b[m][g - 1], q = l < k ? l < h ? l : h : k < h ? k : h, q == h ? (h == d ? a.push(0) : (a.push(1), d = h), m--, g--) : q == l ? (a.push(3), m--, d = l) : (a.push(2), g--, d = k));
    }
  ...
  function Na(a, b) {
    ...
    for (var c = 0, d, e = void 0, f, g = void 0; c < b.length; c++) {
      if (d = b[c], f = La(d), f !== e && (g = a.indexOf(f), e = f), !w(f) || -1 < g) return d;
    }
  }
  ...
  function rb(a, b) {
    if (a) for (a.nodeType === Node.ELEMENT_NODE && b(a), a = a.__shady_firstChild; a; a = a.__shady_nextSibling) {
      a.nodeType === Node.ELEMENT_NODE && rb(a, b);
    }
  }
      ...
      a: {
        ...
        switch (h.nodeType) {
          case Node.ELEMENT_NODE:
            ...
            for (var k = "<" + m, q = h.attributes, B = 0, P; P = q[B]; B++) {
              k += " " + P.name + '="' + P.value.replace(Mb, Ob) + '"';
            }
    ...
    if (this.a) {
      ...
      for (c = 0; c < b.length; c++) {
        ...
        for (var m = h = 0, l = void 0; h < g.length && (l = g[h]); h++) {
          for (var k = 0, q = void 0; k < l.s.length && (q = l.s[k]); k++) {
            q.__shady_native_parentNode === e && e.__shady_native_removeChild(q), f.splice(l.index + m, 1);
          }
        ...
        for (l = void 0; m < g.length && (l = g[m]); m++) {
          for (h = f[l.index], k = l.index; k < l.index + l.v; k++) {
            q = d[k], e.__shady_native_insertBefore(q, h), f.splice(k, 0, q);
          }
        }
      }
    }
