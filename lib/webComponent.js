...
var SignupForm = /*#__PURE__*/function (_HTMLElement) {
  ...
  _createClass(SignupForm, [{
    ...
    value: function connectedCallback() {
      ...
      this.shadowRoot.querySelector('#signupButton').style.backgroundColor = 'black';
...
var FormField = /*#__PURE__*/function (_HTMLElement2) {
  ...
  function FormField() {
    ...
    shadowRoot.appendChild(template.content.cloneNode(true));
    _this3.label = shadowRoot.querySelector('label');
    _this3.input = shadowRoot.querySelector('input');
    return _this3;
  }
